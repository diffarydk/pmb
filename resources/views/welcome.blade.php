                    ...
                    <nav>
                        <div class="menu-bar">
                            ...
                            <div class="menu-links">
                                ...
                                <a href="#" class="menu-link" data-target="jurusan-fasilitas">Jurusan &amp; Fasilitas</a>
                                <a href="#" class="menu-link" data-target="biaya-button">Biaya</a>

                                <a href="{{url('/login')}}" type="button" class="btn btn-warning">Login</button></a>
                                @endif
                            </div>
                        </div>
                    </nav>
